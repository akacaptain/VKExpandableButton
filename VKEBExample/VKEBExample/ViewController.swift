...
class ViewController: UIViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        self.buttonRight.options        = ["Auto" as AnyObject, "On" as AnyObject, "Off" as AnyObject]
        ...
        self.buttonDown.options        = ["Auto" as AnyObject, "On" as AnyObject, "Off" as AnyObject]
        ...
        self.buttonUp.options        = ["Dog" as AnyObject, UIImage(named: "icon2")!, "Mouse" as AnyObject]
